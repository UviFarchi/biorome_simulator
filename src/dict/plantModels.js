export const plantTypes = [
  {
    ...
    description:
      'Perennial forage grass; fast-growing, multiple seasonal cuts; used for hay and pasture.',
  ...
  },
  {
    ...
    description:
      'Root vegetable biennial grown as annual; harvested before flowering; vegetative yield.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 6, startDay: 1, endMonth: 7, endDay: 31 }],
    },
    yield: 40000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 9, startDay: 15, endMonth: 10, endDay: 31 }],
    },
    yield: 35000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Perennial groundcover; produces berries twice per season; requires pollination for fruit set.',
    // Ontogeny
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
  ...
  },
  {
    ...
    description:
      'Perennial shrub with acidic soil preference; requires pollinators; fruits midsummer.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
  ...
  },
  {
    ...
    description:
      'Perennial shrub native to tropical climates; insect-pollinated; produces coffee cherries.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 11, startDay: 1, endMonth: 1, endDay: 31 }],
    },
    yield: 3000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 9, startDay: 1, endMonth: 10, endDay: 15 }],
    },
    yield: 30000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Deciduous fruit tree; insect-pollinated; produces pears late summer to early fall.',
    growthStages: ['seed', 'seedling', 'sapling', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
  ...
  },
  {
    ...
    description:
      'Woody perennial vine; requires pollination; widely cultivated for wine, table grapes, and raisins.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 8, startDay: 15, endMonth: 10, endDay: 1 }],
    },
    yield: 25000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Perennial deciduous nut tree; deep-rooted, heavy spring bloom, high pollinator demand; leaf litter adds organic matter.',
    // Ontogeny
    growthStages: ['seed', 'seedling', 'sapling', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 8, startDay: 1, endMonth: 9, endDay: 15 }],
    },
    yield: 2800,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Evergreen citrus; long fruiting window in mild climates; aromatic blossoms attract pollinators.',
    growthStages: ['seed', 'seedling', 'sapling', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    daysPerGrowthStage: [30, 730, 730, 3650, 3650],
    fruiting: {
  ...
  },
  {
    ...
    description:
      'Evergreen citrus with multiple flushes; sensitive to cold; aromatic flowers attract pollinators.',
    growthStages: ['seed', 'seedling', 'sapling', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 11, startDay: 1, endMonth: 2, endDay: 28 }],
    },
    yield: 35000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Long-lived deciduous hardwood; produces acorns as seasonal fruit; wind-pollinated.',
    growthStages: ['seed', 'seedling', 'sapling', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 10, startDay: 1, endMonth: 11, endDay: 15 }],
    },
    yield: 250000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Fast-growing deciduous tree; commonly used for timber and biomass; wind-pollinated catkins.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 11, startDay: 1, endMonth: 12, endDay: 31 }],
    },
    yield: 100000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Moisture-loving deciduous tree; fast growth; valued for bark and timber; wind-pollinated catkins.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      stages: ['flowering', 'seed_catkin', 'ripe', 'overripe'],
      daysPerStage: [7, 30, 7, 0],
      fruitingWindows: [{ startMonth: 1, startDay: 1, endMonth: 2, endDay: 28 }],
    },
    yield: 30000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Staple aquatic cereal; requires flooded conditions; wind-pollinated during flowering.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
  ...
  },
  {
    ...
    description:
      'Aquatic perennial; sacred lotus with edible rhizomes; insect-pollinated flowers above water.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 7, startDay: 1, endMonth: 8, endDay: 31 }],
    },
    yield: 2000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Fast-growing semi-aquatic vegetable; propagated by cuttings or seeds; primarily vegetative yield.',
    growthStages: ['seed', 'seedling', 'juvenile', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 6, startDay: 1, endMonth: 8, endDay: 31 }],
    },
    yield: 15000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Tiny floating aquatic plant; reproduces vegetatively at rapid rates; harvested as biomass.',
    ...
    fruiting: {
      ...
      daysPerStage: [7, 7],
      fruitingWindows: [{ startMonth: 6, startDay: 1, endMonth: 9, endDay: 30 }],
    },
    yield: 500,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
  ...
  },
  {
    ...
    description:
      'Invasive aquatic species; fast growth; purple flowers; insect-pollinated but harvested as biomass.',
    growthStages: ['vegetative', 'mature', 'old'],
    heightPerGrowthStage: [0, 10, 20, 30],
    ...
    fruiting: {
      ...
      fruitingWindows: [{ startMonth: 7, startDay: 1, endMonth: 9, endDay: 30 }],
    },
    yield: 1000,
    seedRate_kg_per_ha: 10,
    seedlingDensity_per_ha: 10,
