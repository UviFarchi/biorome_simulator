...
const moduleTypes = [
  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      setAirflow: { params: { flow_cfm: Number }, caps: { flow_cfm: [50, 1000] } },
    },
    state: {
...

  {
    ...
    exposedFunctions: {
      fireAirJet: {
        params: { lane: Number, duration_ms: Number },
        caps: { lanes: [2, 16], duration_ms: [10, 200] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      readAlarmStatus: { params: {}, caps: {} },
      triggerAudioAlarm: {
        params: { level: Number, duration_s: Number },
        caps: { level: [1, 10], duration_s: [1, 600] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    exposedFunctions: {
      ...
      triggerElectricAlarm: {
        params: { level: Number, duration_s: Number },
        caps: { level: [1, 5], duration_s: [1, 10] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    parentPortsUsed: 0,
    exposedFunctions: {
      emitAlert: { params: { level: String }, caps: {} },
      trackAnimal: { params: {}, caps: {} },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    exposedFunctions: {
      moldBox: {
        params: { dims: { w_m: Number, h_m: Number, d_m: Number } },
        caps: { volume_L: [0.5, 5] },
      },
    },
    state: {
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      captureIR: { params: { res_px: Number }, caps: { temp_range_C: [-20, 200] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      captureMS: { params: { res_px: Number, bands: Number }, caps: { bands: [4, 12] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    state: {
      health: { ok: Boolean, faultCode: String },
      temperatureRange_C: { min: Number, max: Number },
    },
  },
...

  {
    ...
    exposedFunctions: {
      setLink: {
        params: { target: ['opsEngine', 'peer'], qos: { latency_ms: Number, reliability: Number } },
        caps: {},
      },
      getLinkStatus: { params: {}, caps: {} },
    },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      joinNetwork: { params: { netId: String }, caps: {} },
      getLinkStatus: { params: {}, caps: {} },
    },
...

  {
    ...
    exposedFunctions: {
      ...
      setControlCycle: {
        params: { period_ms: Number, programId: String },
        caps: { period_ms: [5, 1000] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    exposedFunctions: {
      transferMass: {
        params: { mass_kg: Number, from: String, to: String },
        caps: { mass_kg: [0, 50] },
      },
    },
    state: {
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      setGatePosition: { params: { position: Number }, caps: { positions: [2, 4] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
  ...
  },
  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      grind: { params: { throughput_kgph: Number }, caps: { throughput_kgph: [50, 500] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    exposedFunctions: {
      pulse: {
        params: { level: Number, duration_ms: Number },
        caps: { level: [1, 5], duration_ms: [10, 100] },
      },
      status: { params: {}, caps: {} },
    },
    state: {
...

  {
    ...
    exposedFunctions: {
      getFix: { params: {}, caps: {} },
      getHeading: { params: {}, caps: {} },
      getRTKFix: { params: {}, caps: {} },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      extend: { params: { length_m: Number }, caps: { length_m: [0, 50] } },
      retract: { params: { length_m: Number }, caps: { length_m: [0, 50] } },
      lock: { params: { state: Boolean }, caps: {} },
    },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      cleanAirLaminar: { params: { level: String }, caps: { level: ['laminar'] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    exposedFunctions: {
      pointTo: {
        params: { target: { x: Number, y: Number, z: Number }, frame: ['assembly', 'world'] },
        caps: {},
      },
      getObjectLocalCoordinates: {
        params: { class: String, minConfidence: Number, maxN: Number },
        caps: {},
      },
    },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      scanLidar2d: { params: { range_m: Number, resolution_deg: Number }, caps: {} },
    },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      scanLidar3d: { params: { range_m: Number, vFov_deg: Number, hFov_deg: Number }, caps: {} },
    },
...

  {
    ...
    exposedFunctions: {
      ...
      setHome: {
        params: { position_m: { x: Number, y: Number, z: Number }, frame: ['world', 'assembly'] },
        caps: {},
      },
...

  {
    ...
    exposedFunctions: {
      runPump: {
        params: { flow_Lps: Number, duration_s: Number },
        caps: { flow_Lps: [0.1, 1.2], duration_s: [1, 3600] },
      },
...

  {
    ...
    exposedFunctions: {
      compressMaterial: {
        params: { force_kN: Number, stroke_m: Number },
        caps: { force_kN: [50, 400], stroke_m: [0, 1.2] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
  ...
  },
  {
    ...
    exposedFunctions: {
      coreSample: {
        params: { depth_m: Number, diameter_mm: Number },
        caps: { depth_m: [0, 0.5], diameter_mm: [10, 50] },
      },
      ejectCore: { params: {}, caps: {} },
    },
    state: { health: { ok: Boolean, faultCode: String } },
  },

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      readSoilEC: { params: {}, caps: {} },
      calibrateEC: { params: { standard_mScm: Number }, caps: {} },
    },
...

  {
    ...
    exposedFunctions: {
      probeSoil: {
        params: { depth_m: Number, parameters: ['moisture', 'temp', 'ec', 'ph'], dwell_s: Number },
        caps: { depth_m: [0, 1] },
      },
    },
...

  {
    ...
    exposedFunctions: {
      classify: {
        ...
        caps: { classes: ['plastic', 'paper', 'cardboard', 'metal', 'glass', 'bio'] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    exposedFunctions: {
      dispense: {
        params: { points: { items: 'geo.coord[]' }, amount_g_each: Number },
        caps: { amount_g_each: [1, 100] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
  ...
  },
  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      generateSteam: { params: { rate_kg_per_h: Number }, caps: { rate_kg_per_h: [5, 50] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    exposedFunctions: {
      sterilize: {
        params: { temp_C: Number, duration_s: Number },
        caps: { temp_C: [110, 134], duration_s: [300, 7200] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      brushArea: { params: { area: 'plan.area', rpm: Number }, caps: { rpm: [200, 1200] } },
    },
...

  {
    ...
    exposedFunctions: {
      cutPolyline: {
        params: { path: 'geo.path', depth_m: Number, feed_mps: Number },
        caps: { depth_m: [0, 0.05], feed_mps: [0, 0.6] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    exposedFunctions: {
      digTrench: {
        params: { path: 'geo.path', width_m: Number, depth_m: Number },
        caps: { width_m: [0.05, 0.2], depth_m: [0, 0.3] },
      },
    },
    state: { health: { ok: Boolean, faultCode: String } },
  },

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      flattenArea: { params: { area: 'plan.area', passes: Number }, caps: { passes: [1, 5] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
...

  {
    ...
    exposedFunctions: {
      gradeProfile: {
        params: { path: 'geo.path', target_z_m: Number },
        caps: { target_z_m: [-0.1, 0.1] },
      },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
...

  {
    ...
    exposedFunctions: {
      snip: {
        params: { points: { items: 'geo.coord[]' } },
        caps: { branch_diameter_m: [0, 0.02] },
      },
    },
    state: { health: { ok: Boolean, faultCode: String } },
  },

  {
    ...
    exposedFunctions: {
      mow: {
        params: { area: 'plan.area', height_m: Number, speed_mps: Number },
        caps: { height_m: [0.02, 0.08], speed_mps: [0.2, 1.5] },
      },
    },
...

  {
    ...
    exposedFunctions: {
      seedRows: {
        params: { rows: { items: 'line[]' }, rate_seeds_per_m: Number, depth_m: Number },
        caps: { rate_seeds_per_m: [5, 60], depth_m: [0.01, 0.05] },
      },
    },
...

  {
    ...
    exposedFunctions: {
      spray: {
        params: { area: 'plan.area', rate_Lps: Number, droplet_um: Number, pressure_kPa: Number },
        caps: { rate_Lps: [0, 5], pressure_kPa: [50, 600] },
      },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      rangeTo: { params: { peerId: String }, caps: {} },
      getPose: { params: {}, caps: {} },
    },
...

  {
    ...
    parentPortsUsed: 1,
    exposedFunctions: {
      setValvePosition: { params: { open_pct: Number }, caps: { open_pct: [0, 100] } },
    },
    state: {
      health: { ok: Boolean, faultCode: String },
      mode: String,
