...
function restart() { localStorage.removeItem('bioromeUser'); window.location.reload() }
</script>
...
<template>
  <div id="controlPanel" class="panel">
    ...
    <div class="panel-body" v-show="!collapsed">
      ...
      <div id="showAnalytics" class="statusBarCell" @click.stop="eventBus.emit('menu', { target: 'analytics' })">Show Analytics</div>
