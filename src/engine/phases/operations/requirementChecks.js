...
function getMatchingModuleNames(requirements, availableModules) {
  return requirements.map((requirement) => {
    const candidates = availableModules.filter((module) => {
      ...
      if (
        Object.prototype.hasOwnProperty.call(requirement, 'subtype') &&
...
export { assemblyMeetsRequirements, getRequirements, getMatchingModuleNames, canAssemblyMoveAlone };
